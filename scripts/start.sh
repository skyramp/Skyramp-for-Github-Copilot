...
curl -o /etc/skyramp/docker-compose.yml https://raw.githubusercontent.com/letsramp/Skyramp-for-Github-Copilot/main/.devcontainer/scripts/docker-compose.yml
